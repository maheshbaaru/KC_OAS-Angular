...
export class LeavesService {
  ...
  applyleave(
    ...
    return this.http.post(
      `${this.API_CALL}/ApplyLeave?EmpId=${userdata.id}&LeaveTypeId=${LeaveTypeId}&NumOfDays=${diffDays}&FromDate=${FromDate}&ToDate=${ToDate}&Comments=${Comments}&Appliedon=${currentDate}&StatusId=${StatusId}`,
      this.httpOptions
    );
  }
  employeeLeaves(
